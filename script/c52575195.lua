...
function c52575195.tgcon1(e,tp,eg,ep,ev,re,r,rp)
	if e:GetHandler():GetFlagEffect(52575195)~=0 or rp==tp or not re:IsHasProperty(EFFECT_FLAG_CARD_TARGET) then return false end
...
function c52575195.tgcon2(e,tp,eg,ep,ev,re,r,rp)
	if e:GetHandler():GetFlagEffect(52575195)~=0 or tp==Duel.GetTurnPlayer() then return false end
...
function c52575195.tgtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e:GetHandler():RegisterFlagEffect(52575195,RESET_EVENT+0x1fe0000+RESET_CHAIN,0,1)
