...
function c95000160.initial_effect(c)
	...
	e5:SetValue(c95000160.aclimit)
	c:RegisterEffect(e5)
	--~ Add Action Card
	local e6=Effect.CreateEffect(c)
	e6:SetDescription(aux.Stringid(95000160,0))
	e6:SetType(EFFECT_TYPE_QUICK_O)
	e6:SetRange(LOCATION_SZONE)
	e6:SetCode(EVENT_FREE_CHAIN)
	e6:SetCondition(c95000160.condition)
	e6:SetTarget(c95000160.Acttarget)
	e6:SetOperation(c95000160.operation)
	c:RegisterEffect(e6)
	--cannot change zone
...
function c95000160.aclimit(e,re,tp)
