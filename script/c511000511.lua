...
function c511000511.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.IsExistingMatchingCard(c511000511.filter,tp,LOCATION_GRAVE,0,1,nil,e,tp,tid) end
...
function c511000511.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c511000511.spfilter,tp,LOCATION_EXTRA,0,1,1,nil,e,tp,e:GetLabel())
