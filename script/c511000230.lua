...
function c511000230.initial_effect(c)
	...
	e1:SetCountLimit(1)
	e1:SetValue(c511000230.valcon)
	c:RegisterEffect(e1)
	--atk
	local e2=Effect.CreateEffect(c)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e2:SetCode(EVENT_BATTLED)
	e2:SetCondition(c511000230.con)
	e2:SetCost(c511000230.cost)
	e2:SetTarget(c511000230.tg)
	e2:SetOperation(c511000230.op)
	c:RegisterEffect(e2)
end
c511000230.xyz_number=1
function c511000230.valcon(e,re,r,rp)
