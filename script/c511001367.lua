...
function c511001367.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c511001367.cfilter,tp,LOCATION_MZONE,0,1,nil,e,tp) end
...
function c511001367.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c511001367.filter,tp,LOCATION_GRAVE,0,1,1,nil,e:GetLabel(),e,tp)
