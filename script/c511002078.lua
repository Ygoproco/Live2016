...
function c511002078.initial_effect(c)
	...
	e1:SetCost(c511002078.cost)
	e1:SetTarget(c511002078.target)
	e1:SetOperation(c511002078.activate)
	c:RegisterEffect(e1)
end
function c511002078.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	e:SetLabel(1)
	return true
end
...
function c511002078.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		e:SetLabel(0)
		return Duel.IsExistingMatchingCard(c511002078.filter,tp,LOCATION_MZONE,0,1,nil)
	end
end
