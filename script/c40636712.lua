...
function c40636712.initial_effect(c)
	...
	e1:SetCountLimit(1)
	e1:SetCost(c40636712.tgcost)
	e1:SetTarget(c40636712.tgtg)
	e1:SetOperation(c40636712.tgop)
	c:RegisterEffect(e1)
	--extra att
...
function c40636712.tgcost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c40636712.tgtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c40636712.tgop(e,tp,eg,ep,ev,re,r,rp)
