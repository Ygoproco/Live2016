...
function c74063034.initial_effect(c)
	...
	e2:SetTarget(c74063034.thtg)
	e2:SetOperation(c74063034.thop)
	c:RegisterEffect(e2)
end
...
function c74063034.thfil(c)
	return c:IsCode(86120751) and c:IsAbleToHand() and c:IsFaceup()
end
function c74063034.thtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_REMOVED) and chkc:IsControler(tp) and c74063034.thfil(chkc) end
	local c=e:GetHandler()
	if chk==0 then return c:IsAbleToDeck() and Duel.IsExistingTarget(c74063034.thfil,tp,LOCATION_REMOVED,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectTarget(tp,c74063034.thfil,tp,LOCATION_REMOVED,0,1,1,nil)
	Duel.SetOperationInfo(0,CATEGORY_TODECK,c,1,0,0)
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,g,1,0,0)
end
function c74063034.thop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
