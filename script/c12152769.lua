...
function c12152769.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if hg:GetCount()>0 and Duel.SelectYesNo(1-tp,aux.Stringid(12152769,1)) then
		...
		e1:SetTarget(c12152769.reptg)
		e1:SetOperation(c12152769.repop)
		sg:GetFirst():RegisterEffect(e1)
		sg:GetFirst():RegisterFlagEffect(12152769,0,0,1)
...
function c12152769.reptg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return c:GetDestination()==LOCATION_GRAVE and c:GetFlagEffect(12152769)>0 and c:IsLocation(LOCATION_HAND) end
	return true
end
function c12152769.repop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():ResetFlagEffect(12152769)
