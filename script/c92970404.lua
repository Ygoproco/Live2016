...
function c92970404.initial_effect(c)
	...
	e1:SetTarget(c92970404.ptg)
	e1:SetOperation(c92970404.pop)
	c:RegisterEffect(e1)
	--special summon
...
function c92970404.pfil(c)
	return c:IsFaceup() and c:IsCanTurnSet()
end
function c92970404.ptg(e,tp,eg,ep,ev,re,r,rp,chk)
	local g=Duel.GetMatchingGroup(c92970404.pfil,tp,LOCATION_MZONE,LOCATION_MZONE,e:GetHandler())
	if chk==0 then return g:GetCount()>0 end
	Duel.SetOperationInfo(0,CATEGORY_POSITION,g,g:GetCount(),0,0)
end
function c92970404.pop(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetMatchingGroup(c92970404.pfil,tp,LOCATION_MZONE,LOCATION_MZONE,e:GetHandler())
