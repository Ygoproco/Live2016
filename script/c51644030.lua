...
function c51644030.initial_effect(c)
	...
	e1:SetOperation(c51644030.atkup)
	c:RegisterEffect(e1)
	--Decrease ATK
	...
	e2:SetOperation(c51644030.atkop)
	c:RegisterEffect(e2)
end
function c51644030.atkup(e,tp,eg,ep,ev,re,r,rp)
...
function c51644030.atkop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
