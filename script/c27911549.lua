...
function c27911549.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	e2:SetTarget(c27911549.reptg)
	e2:SetOperation(c27911549.repop)
	c:RegisterEffect(e2)
	c:RegisterFlagEffect(27911549,0,0,1)
end
...
function c27911549.reptg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return c:GetDestination()==LOCATION_GRAVE and c:GetFlagEffect(27911549)>0 and c:IsLocation(LOCATION_HAND) end
	return true
end
function c27911549.repop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():ResetFlagEffect(27911549)
