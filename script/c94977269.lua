...
function c94977269.check1(c,mg,sg,chkf)
	local g=mg:Clone()
	if sg:IsContains(c) then g:Sub(sg) end
	return g:IsExists(c94977269.check2,1,c,c,chkf)
end
function c94977269.check2(c,c2,chkf)
...
function c94977269.fuscon(e,g,gc,chkf)
	...
	if gc then
		...
		return c94977269.check1(gc,mg,sg,chkf)
	end
	return mg:IsExists(c94977269.check1,1,nil,mg,sg,chkf)
end
