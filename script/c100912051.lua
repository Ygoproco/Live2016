...
function c100912051.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(100912051,0))
	...
	e3:SetDescription(aux.Stringid(100912051,1))
...
function c100912051.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsControler(tp) and chkc:IsLocation(LOCATION_GRAVE) and c100912051.spfilter(chkc,e,tp) end
...
function c100912051.thfilter(c)
	return c:IsSetCard(0x98) and c:GetType()==TYPE_SPELL+TYPE_CONTINUOUS and not c:IsCode(100912051) and c:IsAbleToHand()
end
