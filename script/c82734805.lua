...
function c82734805.fcfilter0(c)
	return c:IsFusionSetCard(0xbb) and not c:IsHasEffect(6205579)
end
function c82734805.fcfilter1(c,code1,code2,g)
	return c:IsFusionCode(code1,code2) and g:IsExists(c82734805.fcfilter0,1,c)
end
function c82734805.fcfilter2(c,code,g,fc)
	return (c:IsFusionCode(code) or c:CheckFusionSubstitute(fc)) and g:IsExists(c82734805.fcfilter0,1,c)
end
...
function c82734805.fcfilter7(c,chkf,fc)
	return aux.FConditionCheckF(c,chkf) and (c82734805.fcfilter0(c) or c:CheckFusionSubstitute(fc))
end
function c82734805.fscon(e,g,gc,chkf)
	...
	if gc then
		...
		elseif c82734805.fcfilter0(gc) then
	...
	while tc do
		...
		elseif c82734805.fcfilter0(tc) then
...
function c82734805.fsop(e,tp,eg,ep,ev,re,r,rp,gc,chkf)
	...
	if gc then
		...
		if not mg:IsExists(c82734805.fcfilter0,2,tc1) then
			mg2:Remove(c82734805.fcfilter0,nil)
		end
	...
	mg:Sub(g1)
	mg=mg:Filter(c82734805.fcfilter0,nil)
