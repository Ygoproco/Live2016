...
function c17663375.filter(c)
	return c:IsSetCard(0x7) and not c:IsCode(17663375) and c:IsAbleToHand()
end
function c17663375.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c17663375.filter,tp,LOCATION_DECK,0,1,nil) end
...
function c17663375.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c17663375.filter,tp,LOCATION_DECK,0,1,1,nil)
