...
function c92092092.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and 
		Duel.IsPlayerCanSpecialSummonMonster(tp,92092092,0,0x11,0,1800,1,RACE_MACHINE,ATTRIBUTE_FIRE) end
...
function c92092092.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetLocationCount(tp,LOCATION_MZONE)<=0
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,92092092,0,0x11,0,1800,1,RACE_MACHINE,ATTRIBUTE_FIRE) then return end
	...
	e1:SetTarget(c92092092.indtg)
	e1:SetValue(1)
	c:RegisterEffect(e1,true)
	local e2=e1:Clone()
	e2:SetCode(EFFECT_INDESTRUCTABLE_EFFECT)
	e2:SetValue(c92092092.indval)
...
function c92092092.indval(e,re,rp)
