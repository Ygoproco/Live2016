...
function c31111109.ffilter2(c)
	return c:IsFusionSetCard(0x1f) and not c:IsHasEffect(6205579)
end
function c31111109.ffilter3(c)
	return c:IsFusionSetCard(0x8) and not c:IsHasEffect(6205579)
end
function c31111109.fuscon(e,g,gc,chkf)
	if g==nil then return false end
	if gc then return false end
	local g1=g:Filter(c31111109.ffilter1,nil)
	local c1=g1:GetCount()
	local g2=g:Filter(c31111109.ffilter2,nil)
	local c2=g2:GetCount()
	local g3=g:Filter(c31111109.ffilter3,nil)
...
function c31111109.fusop(e,tp,eg,ep,ev,re,r,rp,gc,chkf)
	...
	local g1=eg:Filter(c31111109.ffilter1,nil)
	local g2=eg:Filter(c31111109.ffilter2,nil)
	local g3=eg:Filter(c31111109.ffilter3,nil)
	local ag=g1:Clone()
	ag:Merge(g2)
	ag:Merge(g3)
