...
function c100212100.initial_effect(c)
	--Activate
	...
	e1:SetTarget(c100212100.target)
	e1:SetOperation(c100212100.activate)
	c:RegisterEffect(e1)
	--destroy replace
	...
	e2:SetTarget(c100212100.reptg)
	e2:SetValue(c100212100.repval)
	e2:SetOperation(c100212100.repop)
	c:RegisterEffect(e2)
end
...
function c100212100.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	while tc do
		if tc:AddCounter(0x1041,1) and tc:GetLevel()>1 then
			...
			e1:SetCondition(c100212100.lvcon)
			e1:SetValue(1)
...
function c100212100.lvcon(e)
	return e:GetHandler():GetCounter(0x1041)>0
end
function c100212100.repfilter(c,tp)
...
function c100212100.reptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsAbleToRemove() and eg:IsExists(c100212100.repfilter,1,nil,tp) end
	return Duel.SelectYesNo(tp,aux.Stringid(100212100,0))
end
function c100212100.repval(e,c)
	return c100212100.repfilter(c,e:GetHandlerPlayer())
end
function c100212100.repop(e,tp,eg,ep,ev,re,r,rp)
