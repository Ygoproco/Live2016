...
function c511001050.filter(c,e,tp)
	return c:IsCode(77462146) and Duel.IsPlayerCanSpecialSummonMonster(tp,77462146,0,0x11,4,0,300,RACE_WARRIOR,ATTRIBUTE_DARK)
end
...
function c511001050.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>0 then
		...
		while tc do
			...
			e1:SetValue(TYPE_NORMAL+TYPE_MONSTER+TYPE_SPELL)
