...
function c7537.initial_effect(c)
	c:EnableReviveLimit()
	--spsummon condition
	...
	e2:SetDescription(aux.Stringid(7537,0))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON+CATEGORY_TOHAND)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e2:SetCode(EVENT_SPSUMMON_SUCCESS)
	e2:SetProperty(EFFECT_FLAG_DELAY)
	e2:SetCondition(c7537.ritcon)
	e2:SetTarget(c7537.rittg)
	e2:SetOperation(c7537.ritop)
	c:RegisterEffect(e2)
	--
	...
	e3:SetOperation(c7537.regop)
	c:RegisterEffect(e3)
end

function c7537.ritcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsSummonType(SUMMON_TYPE_RITUAL)
end
function c7537.rittg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c7537.spfil(c,e,tp)
	return c:IsType(TYPE_SPIRIT) and c:IsLevelBelow(4) and c:IsCanBeSpecialSummoned(e,0,tp,true,false)
end
function c7537.ritop(e,tp,eg,ep,ev,re,r,rp)
	local mg=Duel.GetMatchingGroup(c7537.spfil,tp,LOCATION_HAND,0,nil,e,tp)
...
function c7537.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetCondition(c7537.sprcon)
	e1:SetTarget(c7537.sprtg)
	e1:SetOperation(c7537.sprop)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
	e2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	c:RegisterEffect(e2)
end
function c7537.sprcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
...
function c7537.sprtg(e,tp,eg,ep,ev,re,r,rp,chk)
	local b=true
...
function c7537.sprop(e,tp,eg,ep,ev,re,r,rp)
	if CARD_BLUEEYES_SPIRIT then
