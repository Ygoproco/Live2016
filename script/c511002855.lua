...
function c511002855.initial_effect(c)
	...
	e1:SetCountLimit(1)
	e1:SetCondition(c511002855.uncon)
	e1:SetOperation(c511002855.unop)
	c:RegisterEffect(e1)
	--draw
	...
	e2:SetCondition(c511002855.condition)
	e2:SetCost(c511002855.cost)
	e2:SetTarget(c511002855.target)
	e2:SetOperation(c511002855.operation)
	c:RegisterEffect(e2)
end
...
function c511002855.condition(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,30741334) and aux.bdocon(e,tp,eg,ep,ev,re,r,rp)
end
